const employee = {
                    ...
                    <div class="d-flex flex-row bd-highlight mb-3">
                        <div class="p-2 w-50 bd-highlight">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select type="text" class="form-control" v-model="DepartmentId">
                        ...
                        <div class="p-2 w-50 bd-highlight">
                            <img style="max-width: 250px;"
                             :src="PhotoPath+PhotoFileName" alt="Profile Photo"/>
    ...
    methods:{
        ...
        getDepartmentName(depId){
            let obj = this.departments.find(o => o.DepartmentId == depId);
